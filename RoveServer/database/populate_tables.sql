...
INSERT INTO `rove`.`posts` (`post_id`, `user_id`, `latitude`, `longitude`, `message`) VALUES ('2', '2', '22.2', '22.2', 'Farran was here!');

INSERT INTO `rove`.`posts` (`post_id`, `user_id`, `latitude`, `longitude`, `message`) VALUES ('3', '3', '33.3', '33.3', 'Phong was here!');

INSERT INTO `rove`.`posts` (`post_id`, `user_id`, `latitude`, `longitude`, `message`) VALUES ('4', '4', '44.4', '44.4', 'Mark was here!');
